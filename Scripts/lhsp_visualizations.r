...
### Data input
############################################################
default <- read_csv("Output/sims_default.txt", col_names=TRUE) %>%
...
compensation1 <- read_csv("Output/sims_compensate1.txt", col_names=TRUE) %>%
			  mutate(model="compensation1",
...
retaliation1 <- read_csv("Output/sims_retaliate1.txt", col_names=TRUE) %>%
			 mutate(model="retaliation1",
...
data <- bind_rows(default, 
				  noOverlap, overlapRand,
	          	  compensation1, compensation2,
		  		  retaliation1, retaliation2) %>%
